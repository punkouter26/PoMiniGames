...
.DESCRIPTION
  ...
  Serilog + Azure Monitor OTel wiring (see src/PoMiniGames/Infrastructure/
...
Write-Host "  - src/PoMiniGames/Infrastructure/TelemetryExtensions.cs" -ForegroundColor Gray
Write-Host "  - src/PoMiniGames/Infrastructure/LoggingExtensions.cs" -ForegroundColor Gray
