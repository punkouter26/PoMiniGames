...
.DESCRIPTION
  ...
  Serilog + Azure Monitor OTel wiring (see src/PoMiniGames/PoMiniGames/Infrastructure/
...
Write-Host "  - src/PoMiniGames/PoMiniGames/Infrastructure/TelemetryExtensions.cs" -ForegroundColor Gray
Write-Host "  - src/PoMiniGames/PoMiniGames/Infrastructure/LoggingExtensions.cs" -ForegroundColor Gray
