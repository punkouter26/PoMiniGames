...
// BrawlGame was one 5,400-line class. These three modules hold its personality/
// super system, its transient VFX layer and its KO-sequence + camera code, mixed
// into the prototype below so `this` and every call site are unchanged. mixin.js
// explains why prototypes rather than free functions or Object.assign.
...
mixin(BrawlGame.prototype, SceneSetup, PersonalityEffects, Vfx, Cinematics);
