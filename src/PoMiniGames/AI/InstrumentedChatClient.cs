...
/// per-game <see cref="PoShared.Simulation.Models.InferenceHealthTracker"/>.
/// </summary>
/// <remarks>
/// <para>
...
public sealed class InstrumentedChatClient : DelegatingChatClient
{
    ...
    private readonly PoShared.Simulation.Models.InferenceHealthTracker _health;
    ...
    public InstrumentedChatClient(
        ...
        PoShared.Simulation.Models.InferenceHealthTracker health)
        : base(innerClient)
    {
        _game = game;
