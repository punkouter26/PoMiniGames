...
[`PoMiniGames.E2EAPI`](../PoMiniGames.E2EAPI/) project.
...
> Not run in CI by default (needs browser binaries). Add a `playwright install`
> step to `.github/workflows/deploy.yml` before enabling it there.
